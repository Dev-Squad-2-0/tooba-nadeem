...
MODEL_PATH = MODEL_DIR / "top_player_random_forest.joblib"
FEATURES_PATH = DATA_DIR / "player_prediction_features.csv"

MATCH_MODEL_PATH = MODEL_DIR / "match_winner_gradient_boosting.joblib"
MATCH_FEATURES_PATH = DATA_DIR / "match_prediction_features.csv"
...
def predict_match_winner(
    ...
    # Use the actual home/away orientation stored in the dataset.
    actual_home_team = match.iloc[0]["home_team"]
    actual_away_team = match.iloc[0]["away_team"]
    ...
    if predicted_class == 1:
        predicted_winner = actual_home_team
    else:
        predicted_winner = actual_away_team
